...
describe('Select placeholder', () => {
  it('when searchValue is controlled', () => {
    ...
    expect(container.querySelector('.rc-select-pro-selection-placeholder')).not.toHaveStyle({
      visibility: 'hidden',
    });
    toggleOpen(container);
    expect(container.querySelector('.rc-select-pro-selection-placeholder')).toHaveStyle({
      visibility: 'hidden',
    });
  });
  ...
  it('when value is null', () => {
    ...
    expect(container.querySelector('.rc-select-pro-selection-placeholder').textContent).toBe('bamboo');
  });
  ...
  it('not when value is null but it is an Option', () => {
    ...
    expect(container.querySelector('.rc-select-pro-selection-item').textContent).toBe('light');
    toggleOpen(container);
    expect(container.querySelector('.rc-select-pro-selection-item').textContent).toBe('light');
  });
  ...
  it('should hide placeholder if force closed and showSearch with searchValue', () => {
    ...
    expect(container.querySelector('.rc-select-pro-selection-placeholder').textContent).toBe(
      'placeholder',
    );
  });
});
